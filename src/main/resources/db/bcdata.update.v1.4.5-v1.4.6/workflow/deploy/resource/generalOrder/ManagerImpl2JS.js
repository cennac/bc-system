...
bswf.generalOrder.ManagerImplForm = {
	...
	buildFormData : function(){
		...
		$form.find(":input[name='is_DI_flow']").val(rhanding);
		...
		if(rhanding=="true"){
			...
			$form.find(":input[name='list_mi_co4department']").val($.toJSON(co4departments));
			$form.find(":input[name='list_impl4departmentAndAssignee']").val($.toJSON(list_departmentAndAssignee));
		}
	},
	...
	validateForm: function(){
		...
		bswf.generalOrder.ManagerImplForm.buildFormData.call(this);

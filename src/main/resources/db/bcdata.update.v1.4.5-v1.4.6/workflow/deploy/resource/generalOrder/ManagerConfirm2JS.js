...
bswf.generalOrder.ManagerConfirmForm = {
	...
	buildFormData : function(){
		...
		if(rhanding=="送相关部门协办"){
			...
			$form.find(":input[name='list_odc4assignee4local']").val($.toJSON(list_departmentAndAssignee));
	...
	validateForm: function(){
		...
		bswf.generalOrder.ManagerConfirmForm.buildFormData.call(this);

...
bswf.generalOrder.ApplyMatterForm = {
	init : function(option,readonly){
		...
		$form.find("#addLine").click(function() {
			...
			cell.innerHTML='<div class="ignore editable input" style="width:100%;height:100%;border:none;background:none;padding:0 0 0 2px;overflow-x:hidden;overflow-y:auto;word-break:break-all;white-space:normal;" data-validate="required" ></div>';
			
			cell=newRow.insertCell(2);
			cell.style.padding="0";
			cell.style.textAlign="left";
			cell.setAttribute("class","middle");
			cell.innerHTML='<div class="ignore editable" style="width:100%;height:100%;border:none;background:none;padding:0 0 0 2px;overflow-x:hidden;overflow-y:auto;word-break:break-all;white-space:normal;" ></div>';

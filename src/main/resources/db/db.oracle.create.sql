...
CREATE INDEX BS_CERT_CODE ON BS_CERT (CERT_CODE ASC);
CREATE INDEX BS_CERT_NAME ON BS_CERT (CERT_NAME ASC);
...
COMMENT ON COLUMN BS_CERT_DRIVING.NATIONALITY IS '国籍';

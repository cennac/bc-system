...
CREATE TABLE BS_CARMAN_CONTRACT (
   ...
   CONSTRAINT BSPK_CARMAN_CONTRACT PRIMARY KEY (CARMAN_ID, CONTRACT_ID)
);
...
COMMENT ON COLUMN BS_CASE_BASE.SOURCE IS '来源：1-用户创建、2-接口导入';
...
COMMENT ON COLUMN BS_CASE_INFRACT_TRAFFIC.IS_CLOSE IS '是否结案：1-结案';
...
COMMENT ON COLUMN BS_CASE_ACCIDENT.DRIVER_AREA IS '司机区域';
...
COMMENT ON COLUMN BS_CASE_ACCIDENT.IS_CLOSE IS '是否结案：1-结案';
...
COMMENT ON TABLE BS_CASE_ADVICE IS '投诉';

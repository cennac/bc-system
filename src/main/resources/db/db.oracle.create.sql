...
COMMENT ON COLUMN BS_MOTORCADE.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_MOTORCADE.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_MOTORCADE.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_MOTORCADE.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.AUTHOR_NAME IS '创建人姓名';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.MODIFIER_ID IS '最后修改人ID';
COMMENT ON COLUMN BS_MOTORCADE_CARQUANTITY.MODIFIER_NAME IS '最后修改人名称';
...
COMMENT ON COLUMN BS_CERT.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_CERT.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_CERT.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_CERT.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
COMMENT ON COLUMN BS_CARMAN.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_CARMAN.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_CARMAN.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_CARMAN.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
CREATE TABLE BS_CAR (
   ...
   UID_                 VARCHAR2(36)         NOT NULL,
   STATUS_              NUMBER(1)            NOT NULL,
   BELONG_UNITID        NUMBER(19)           NOT NULL,
   MANAGE_UNITID        NUMBER(19),
   MOTORCADE_ID         NUMBER(19)           NOT NULL,
   ...
   REDISTER_DATE        VARCHAR2(255),
   OPERATE_DATE         VARCHAR2(255),
   SCRAP_DATE           VARCHAR2(255),
   FACTORY_DATE         VARCHAR2(255),
   REDISTER_NO          VARCHAR2(255),
   LEVEL_               VARCHAR2(255),
   COLOR                VARCHAR2(255),
...
COMMENT ON COLUMN BS_CAR.BELONG_UNITID IS '所属单位ID';
COMMENT ON COLUMN BS_CAR.MANAGE_UNITID IS '分管单位ID';
...
COMMENT ON COLUMN BS_CAR.REDISTER_DATE IS '登记日期';
...
COMMENT ON COLUMN BS_CAR.REDISTER_NO IS '机动车登记编号';
...
COMMENT ON COLUMN BS_CAR.AUTHOR_NAME IS '创建人姓名';
COMMENT ON COLUMN BS_CAR.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_CAR.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_CAR.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_CAR.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
COMMENT ON COLUMN BS_CAR.MODIFIER_ID IS '最后修改人ID';
COMMENT ON COLUMN BS_CAR.MODIFIER_NAME IS '最后修改人名称';
...
COMMENT ON COLUMN BS_CONTRACT.AUTHOR_NAME IS '创建人姓名';
COMMENT ON COLUMN BS_CONTRACT.AUTHOR_DEPART_ID IS '创建人所在部门ID';
COMMENT ON COLUMN BS_CONTRACT.AUTHOR_DEPART_NAME IS '创建人所在部门名称';
COMMENT ON COLUMN BS_CONTRACT.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BS_CONTRACT.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
COMMENT ON COLUMN BS_CONTRACT.MODIFIER_ID IS '最后修改人ID';
COMMENT ON COLUMN BS_CONTRACT.MODIFIER_NAME IS '最后修改人名称';

...
CREATE TABLE BS_CONTRACT (
   ...
   MODIFIER_ID          NUMBER(19),
   MODIFIED_DATE        DATE,
   CONSTRAINT BSPK_CONTRACT PRIMARY KEY (ID)
);
...
COMMENT ON COLUMN BS_CONTRACT.EXT_STR1 IS '字符扩展域1(车牌)';
COMMENT ON COLUMN BS_CONTRACT.EXT_STR2 IS '字符扩展域2(司机姓名)';
...
ALTER TABLE BS_CONTRACT ADD CONSTRAINT BSFK_CONTRACT_TRANSACTOR FOREIGN KEY (TRANSACTOR_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
...
COMMENT ON COLUMN BS_CONTRACT_CHARGER.CHARGER1_ID IS '责任人1ID';
COMMENT ON COLUMN BS_CONTRACT_CHARGER.CHARGER1_NAME IS '责任人1姓名';
COMMENT ON COLUMN BS_CONTRACT_CHARGER.CHARGER2_ID IS '责任人2ID';
COMMENT ON COLUMN BS_CONTRACT_CHARGER.CHARGER2_NAME IS '责任人2姓名';
ALTER TABLE BS_CONTRACT_CHARGER ADD CONSTRAINT BSFK_CONTRACT4CHARGER_CONTRACT FOREIGN KEY (ID)
      REFERENCES BS_CONTRACT (ID);
ALTER TABLE BS_CONTRACT_CHARGER ADD CONSTRAINT BSFK_CONTRACT4CHARGER_CHARGER1 FOREIGN KEY (CHARGER1_ID)
      REFERENCES BS_CARMAN (ID);
ALTER TABLE BS_CONTRACT_CHARGER ADD CONSTRAINT BSFK_CONTRACT4CHARGER_CHARGER2 FOREIGN KEY (CHARGER2_ID)
      REFERENCES BS_CARMAN (ID);
...
ALTER TABLE BS_BLACKLIST ADD CONSTRAINT BSFK_BLACKLIST_MODIFIER FOREIGN KEY (MODIFIER_ID)
      REFERENCES BC_IDENTITY_ACTOR_HISTORY (ID);
ALTER TABLE BS_BLACKLIST ADD CONSTRAINT BSFK_BLACKLIST_UNIT FOREIGN KEY (UNIT_ID)
      REFERENCES BC_IDENTITY_ACTOR (ID);
...
COMMENT ON COLUMN BS_CASE_ACCIDENT.DRIVER_TYPE IS '司机类型：车主等';

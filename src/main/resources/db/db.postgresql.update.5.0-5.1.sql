...
-- #### 车保相关 ####
ALTER TABLE BS_CAR_POLICY ADD COLUMN LIABILITY_AMOUNT  NUMERIC(10,2);
COMMENT ON COLUMN BS_CAR_POLICY.LIABILITY_AMOUNT IS '责任险合计';
ALTER TABLE BS_CAR_POLICY ADD COLUMN COMMERIAL_AMOUNT  NUMERIC(10,2);
COMMENT ON COLUMN BS_CAR_POLICY.COMMERIAL_AMOUNT IS '商业险合计';
ALTER TABLE BS_CAR_POLICY ADD COLUMN GREENSLIP_AMOUNT  NUMERIC(10,2);
COMMENT ON COLUMN BS_CAR_POLICY.GREENSLIP_AMOUNT IS '强制险合计';
ALTER TABLE BS_BUY_PLANT ALTER COLUMN COVERAGE TYPE VARCHAR(400);
ALTER TABLE BS_INSURANCE_TYPE ALTER COLUMN COVERAGE TYPE VARCHAR(400);

...
-- 经办人 --
ALTER TABLE BS_CASE_BASE ADD COLUMN RECEIVER_ID INTEGER;
COMMENT ON COLUMN BS_CASE_BASE.RECEIVER_ID IS '经办人id';
ALTER TABLE BS_CASE_BASE ADD COLUMN RECEIVER_NAME VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.RECEIVER_NAME IS '经办人姓名';

-- 分公司负责人
ALTER TABLE BS_CASE_BASE ADD COLUMN BRANCH_CHARGER_ID INTEGER;
COMMENT ON COLUMN BS_CASE_BASE.BRANCH_CHARGER_ID IS '分公司负责人id';
ALTER TABLE BS_CASE_BASE ADD COLUMN BRANCH_CHARGER_NAME VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.BRANCH_CHARGER_NAME IS '分公司负责人姓名';

-- 公司审批人
ALTER TABLE BS_CASE_BASE ADD COLUMN COMPANY_APPROVAL_ID INTEGER;
COMMENT ON COLUMN BS_CASE_BASE.COMPANY_APPROVAL_ID IS '公司审批人id';
ALTER TABLE BS_CASE_BASE ADD COLUMN COMPANY_APPROVAL_NAME VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.COMPANY_APPROVAL_NAME IS '公司审批人姓名';

-- 补充字段
ALTER TABLE BS_CASE_BASE ADD COLUMN CONTENT VARCHAR(4000);
COMMENT ON COLUMN BS_CASE_BASE.CONTENT IS '内容';
ALTER TABLE BS_CASE_BASE ADD COLUMN STOP_PRODUCTION VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.STOP_PRODUCTION IS '停产';
ALTER TABLE BS_CASE_BASE ADD COLUMN STUDY VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.STUDY IS '学习';
ALTER TABLE BS_CASE_BASE ADD COLUMN DEDIT NUMERIC(10,2);
COMMENT ON COLUMN BS_CASE_BASE.DEDIT IS '违约金';

-- 更新旧有数据
UPDATE BS_CASE_BASE SET DEDIT = 0.0;

ALTER TABLE BS_CASE_BASE ADD COLUMN DRIVER_RATING VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.DRIVER_RATING IS '驾驶员评级';

-- 处理意见 --
ALTER TABLE BS_CASE_BASE ADD COLUMN HANDLER_ID INTEGER;
COMMENT ON COLUMN BS_CASE_BASE.HANDLER_ID IS '处理人id';
ALTER TABLE BS_CASE_BASE ADD COLUMN HANDLER_NAME VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.HANDLER_NAME IS '处理人姓名';
ALTER TABLE BS_CASE_BASE ADD COLUMN HANDLE_STATUS INTEGER;
COMMENT ON COLUMN BS_CASE_BASE.HANDLE_STATUS IS '处理状态';
ALTER TABLE BS_CASE_BASE ADD COLUMN HANDLE_OPINION VARCHAR(255);
COMMENT ON COLUMN BS_CASE_BASE.HANDLE_OPINION IS '处理意见';
ALTER TABLE BS_CASE_BASE ADD COLUMN HANDLE_DATE TIMESTAMP;
COMMENT ON COLUMN BS_CASE_BASE.HANDLE_DATE IS '处理时间';

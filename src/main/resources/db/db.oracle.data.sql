...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	values(CORE_SEQUENCE.NEXTVAL, 0, 0,  1, null, '010000','我的事务', null, 'i0403');
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '010100','待办工作', '/bc/todoWork/list', 'i0001' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '010200','已办工作', '/bc/doneWork/paging', 'i0002' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS)
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '011000','系统反馈', '/bc/feedback/paging', 'i0303' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '011100','个性化设置', '/bc/personal/edit', 'i0302' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '011200','桌面设置', '/bc/shortcut/list', 'i0407' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS)
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '011300','登录日志', '/bc/mysyslog/paging', 'i0208' from BC_IDENTITY_RESOURCE m where m.order_='010000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS)
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '011400','下载浏览器', '/bc/attach/browser', 'i0404' from BC_IDENTITY_RESOURCE m where m.order_='010000';
...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '074101','自动选择', '/bc-test/show?tpl=/bc-test/identity/autoSelect.jsp', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '074102','选择4Actor', '/bc-test/selectIdentity', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '074103','选择日期', '/bc-test/datepicker', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '074104','附件设计', '/bc/attach/design', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '074105','选择4BS', '/bc-test/show?tpl=/bc-business/demo/select.jsp', 'i0300' from BC_IDENTITY_RESOURCE m where m.order_='074100';
-- 常用链接/功能演示/报表演示
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
...
-- 系统维护
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	values(CORE_SEQUENCE.NEXTVAL, 0, 0,  1, null, '800000','系统维护', null, 'i0403');
...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800102','单位配置', '/bc/units/paging', 'i0007' from BC_IDENTITY_RESOURCE m where m.order_='800100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800103','部门配置', '/bc/departments/paging', 'i0008' from BC_IDENTITY_RESOURCE m where m.order_='800100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800104','岗位配置', '/bc/groups/paging', 'i0003' from BC_IDENTITY_RESOURCE m where m.order_='800100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800105','用户配置', '/bc/users/paging', 'i0003' from BC_IDENTITY_RESOURCE m where m.order_='800100';
    
-- 系统维护/权限管理
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
    select CORE_SEQUENCE.NEXTVAL, 0, 0, 1, m.id, '800200','权限管理', null, 'i0403' from BC_IDENTITY_RESOURCE m where m.order_='800000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS)
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800201','资源配置', '/bc/resource/paging', 'i0005' from BC_IDENTITY_RESOURCE m where m.order_='800200';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800202','角色配置', '/bc/role/paging', 'i0006' from BC_IDENTITY_RESOURCE m where m.order_='800200';
...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '800307','消息管理', '/bc/message/paging', 'i0309' from BC_IDENTITY_RESOURCE m where m.order_='800000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS)
...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '031400','营运违章', '/bc-business/caseBusinesss/paging', 'i0705' from BC_IDENTITY_RESOURCE m where m.order_='030000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
...
-- 营运系统/其他-接口数据
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
    select CORE_SEQUENCE.NEXTVAL, 0, 0, 1, m.id, '035100','接口数据', null, 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='030000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '035101','交委交通违法', '/bc-business/jiaoWeiJTWFs/paging', 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='035100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '035102','交委营运违章', '/bc-business/jiaoWeiYYWZs/paging', 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='035100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '035103','交委投诉建议', '/bc-business/jiaoWeiADVICEs/paging', 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='035100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '035104','交委人车关系', '/bc-business/jiaoWeiRCGXs/paging', 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='035100';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '035105','金盾交通违法', '/bc-business/jinDunJTWFs/paging', 'i0802' from BC_IDENTITY_RESOURCE m where m.order_='035100';
...
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '040300','会议信息', '/bc/error/todo', 'i0100' from BC_IDENTITY_RESOURCE m where m.order_='040000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '040400','工作计划', '/bc/error/todo', 'i0208' from BC_IDENTITY_RESOURCE m where m.order_='040000';
insert into BC_IDENTITY_RESOURCE (ID,STATUS_,INNER_,TYPE_,BELONG,ORDER_,NAME,URL,ICONCLASS) 
	select CORE_SEQUENCE.NEXTVAL, 0, 0, 2, m.id, '040500','考勤信息', '/bc/error/todo', 'i0207' from BC_IDENTITY_RESOURCE m where m.order_='040000';
...
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.1', 0, 0, 3, 'ceshigang1','测试岗1', 'a1.b9999.c9999.1','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang1'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.2', 0, 0, 3, 'ceshigang2','测试岗2', 'a1.b9999.c9999.2','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang2'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.3', 0, 0, 3, 'ceshigang3','测试岗3', 'a1.b9999.c9999.3','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang3'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.4', 0, 0, 3, 'ceshigang4','测试岗4', 'a1.b9999.c9999.4','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang4'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.5', 0, 0, 3, 'ceshigang5','测试岗5', 'a1.b9999.c9999.5','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang5'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.6', 0, 0, 3, 'ceshigang6','测试岗6', 'a1.b9999.c9999.6','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
    select 0,am.id,af.id from BC_IDENTITY_ACTOR am,BC_IDENTITY_ACTOR af where am.code='xinxijishubu' and af.code='ceshigang6'; 
insert into BC_IDENTITY_ACTOR (ID,UID_,STATUS_,INNER_,TYPE_,CODE, NAME, ORDER_,PCODE,PNAME) values(CORE_SEQUENCE.NEXTVAL,'group.10.7', 0, 0, 3, 'ceshigang7','测试岗7', 'a1.b9999.c9999.7','[1]baochengzongbu/[2]xinxijishubu','宝城总部/信息技术部');
insert into BC_IDENTITY_ACTOR_RELATION (TYPE_,MASTER_ID,FOLLOWER_ID) 
...
-- 插入选项分组信息
insert into BC_OPTION_GROUP (ID,ORDER_, KEY_, VALUE_, ICON) values (CORE_SEQUENCE.NEXTVAL, '5000', 'motorcade.paymentDate', '车队缴费日', null); 
...
insert into BC_OPTION_GROUP (ID,ORDER_, KEY_, VALUE_, ICON) values (CORE_SEQUENCE.NEXTVAL, '5021', 'ca.sort', '营运事件事故理赔事故性质', null); 
...
insert into BC_OPTION_GROUP (ID,ORDER_, KEY_, VALUE_, ICON) values (CORE_SEQUENCE.NEXTVAL, '5027', 'contract.signType', '签约类型', null); 
...
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '00', '0', '月末', null from BC_OPTION_GROUP g where g.KEY_='motorcade.paymentDate'; 
declare
...
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '01', 'shangren', '伤人', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '02', 'liangchexiangpeng', '两车相碰', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '03', 'qingwen', '轻微', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '04', 'yiban', '一般', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '05', 'zhongda', '重大', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '06', 'teda', '特大', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '07', 'cheliangbeidao', '车辆被盗', null from BC_OPTION_GROUP g where g.KEY_='ca.sort';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '08', 'yuhangrenxiangpeng', '与行人相碰', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '09', 'cheliangbeiqiang', '车辆被抢', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '10', 'zhongdashangren', '重大伤人', null from BC_OPTION_GROUP g where g.KEY_='ca.sort'; 
  
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '01', 'wuze', '无责', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '02', 'quanze', '全责', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '03', 'zhuze', '主责', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '04', 'cize', '次责', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '05', 'tongdeng', '同等', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '06', 'danfangquanze', '单方全责', null from BC_OPTION_GROUP g where g.KEY_='ca.duty'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '07', 'qingshangbuxuzhuyuan', '轻伤不须住院', null from BC_OPTION_GROUP g where g.KEY_='ca.duty';

insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '01', 'keguantongzhi', '客管通知', null from BC_OPTION_GROUP g where g.KEY_='ad.source'; 
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '02', 'dianhua', '电话', null from BC_OPTION_GROUP g where g.KEY_='ad.source';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '03', '96900', '96900', null from BC_OPTION_GROUP g where g.KEY_='ad.source';

insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '01', 'shougongsibiaoyang', '受公司表扬', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '02', 'shouchengkebiaoyang', '受乘客表扬', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '03', 'shouqitadanweibiaoyang', '受其它单位表扬', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '04', 'yueduyouxiu', '被评为月度优秀司机', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '05', 'nianduyouxiu', '被评为年度优秀司机', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 
	select CORE_SEQUENCE.NEXTVAL, 0, g.id, '06', 'jiaohaishiwu', '交还失物', null from BC_OPTION_GROUP g where g.KEY_='pr.type';
insert into BC_OPTION_ITEM (ID,STATUS_, PID, ORDER_, KEY_, VALUE_, ICON) 

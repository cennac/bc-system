...
bswf.companyComplainHandle.accraditationCaseAdviceInfoForm = {
	init : function(option,readonly){
		...
		$form.find("input[type='radio'][name='nextStep']").change(function(){
			...
			var $rhandings=$form.find("input[type='radio'][name='nextStep']");
			var checked=false;
			var value;
			var name;
		...
		function handing_show($div){
			...
			var $ignore=$div.find(".bswf-generalOrder-ignore");
			...
			var $flow=$div.find(".bswf-generalOrder-flow");
			$flow.each(function(){
					$(this).val(true);
			});
	...
	validateForm: function(){
		...
		bswf.companyComplainHandle.accraditationCaseAdviceInfoForm.buildFormData.call(this);

...
values (NEXTVAL('CORE_SEQUENCE'),0,'1001','营运系统/经济合同附件','BC-CBHT-A04','BC-CBHT-A04-20111101',true,false,'contract4Charger.CBHTA04.docx',49152,'承包合同(新承包)',
				(select id from BC_TEMPLATE_TYPE where code='word-docx'),now(),(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'));
insert into BC_TEMPLATE (ID,STATUS_,ORDER_,CATEGORY,CODE,VERSION_,FORMATTED,INNER_,PATH,SIZE_,SUBJECT,TYPE_ID,FILE_DATE,AUTHOR_ID) 
values (NEXTVAL('CORE_SEQUENCE'),0,'1002','营运系统/经济合同附件','BC-CBHT-A0401','BC-CBHT-A0401-20111101',true,false,'contract4Charger.CBHTA0401.docx',49152,'承包合同(旧承包)',
				(select id from BC_TEMPLATE_TYPE where code='word-docx'),now(),(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'));
insert into BC_TEMPLATE (ID,STATUS_,ORDER_,CATEGORY,CODE,VERSION_,FORMATTED,INNER_,PATH,SIZE_,SUBJECT,TYPE_ID,FILE_DATE,AUTHOR_ID) 
values (NEXTVAL('CORE_SEQUENCE'),0,'1003','营运系统/经济合同附件','BC-XYLHT-A00','BC-XYLHT-A00-20120111',true,false,'contract4Charger.XYLHTA00.docx',49152,'承包合同(高峰)',
				(select id from BC_TEMPLATE_TYPE where code='word-docx'),now(),(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'));

...
'],'||chr(13)||
'sql: "tpl:contract4Labour.list.sql",'||chr(13)||
...
-- 模板增加是否允许格式化
ALTER TABLE BC_TEMPLATE ADD COLUMN FORMATED BOOLEAN DEFAULT FALSE;
COMMENT ON COLUMN BC_TEMPLATE.FORMATED IS '格式化：是 否 默认否';
...
insert into  BC_IDENTITY_ROLE (ID, STATUS_,INNER_,TYPE_,ORDER_,CODE,NAME) 
	values(NEXTVAL('CORE_SEQUENCE'), 0, false,  0,'01230', 'BS_SOCIAL_SECURITY_RULE_READ','社保收费规则查询');
...
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'养老',12,8,2018;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'失业',2,1,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'工伤',0.5,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'生育',0.85,0,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'医疗',8,2,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2011),'重疾',0.26,0,4541;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'养老',12,8,2018;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'失业',2,1,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'工伤',0.5,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'生育',0.85,0,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'医疗',8,2,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2011),'重疾',0.26,0,4541;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'养老',12,8,2018;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'失业',2,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'工伤',0.5,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'生育',0.85,0,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'医疗',8,2,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2011),'重疾',0.26,0,4541;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'养老',12,8,2018;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'失业',2,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'工伤',0.5,0,1300;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'生育',0.85,0,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'医疗',8,2,2725;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2011),'重疾',0.26,0,4541;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'养老',12,8,1655;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'失业',0.2,0.1,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'工伤',0.4,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2010),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'养老',12,8,1655;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'失业',0.2,0.1,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'工伤',0.4,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2010),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'养老',12,8,1655;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'失业',0.2,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'工伤',0.4,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2010),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'养老',12,8,1655;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'失业',0.2,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'工伤',0.4,0,1100;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2010),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'养老',12,8,1472;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'失业',0.2,0.1,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'工伤',0.4,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2009),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'养老',12,8,1472;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'失业',0.2,0.1,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'工伤',0.4,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2009),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'养老',12,8,1472;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'失业',0.2,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'工伤',0.4,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2009),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'养老',12,8,1472;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'失业',0.2,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'工伤',0.4,0,860;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'生育',0.85,0,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'医疗',7,2,2268;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2009),'重疾',0.26,0,3780;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'养老',12,8,1329;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'失业',0.2,0.1,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'工伤',0.5,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'生育',0.85,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'医疗',8,2,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地城镇' and start_year=2008),'重疾',0.26,0,3380;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'养老',12,8,1329;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'失业',0.2,0.1,20090;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'工伤',0.5,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'生育',0.85,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'医疗',8,2,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地城镇' and start_year=2008),'重疾',0.26,0,3380;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'养老',12,8,1329;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'失业',0.2,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'工伤',0.5,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'生育',0.85,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'医疗',8,2,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='本地农村' and start_year=2008),'重疾',0.26,0,3380;
...
INSERT INTO BS_SOCIALSECURITYRULE (id,area_id,area_name,start_year,start_month,house_type,author_id,file_date)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bc_placeorigin where code='440100')
				...
				,(select id from BC_IDENTITY_ACTOR_HISTORY where actor_name='系统管理员'),now();
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'养老',12,8,1329;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'失业',0.2,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'工伤',0.5,0,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'生育',0.85,0,20098;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'医疗',8,2,2009;
INSERT INTO BS_SOCIALSECURITYRULE_DETAIL(ID,PID,NAME,UNIT_RATE,PERSONAL_RATE,BASE_NUMBER)
	select NEXTVAL('CORE_SEQUENCE'),(select id from bs_socialsecurityrule where house_type='外地农村' and start_year=2008),'重疾',0.26,0,3380;
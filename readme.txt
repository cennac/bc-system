...
1)备份原有数据库
2)发布测试系统
>mvn clean package -Poracle -Ddb.type=oracle -Ddb.name=orcl -Ddb.ip=192.168.0.222 -Dapp.debug=false -Ddb.username=bctest -Ddb.password=bctest -Dapp.data.realPath=/file/bcdata4test -Dapp.ts=20111102
